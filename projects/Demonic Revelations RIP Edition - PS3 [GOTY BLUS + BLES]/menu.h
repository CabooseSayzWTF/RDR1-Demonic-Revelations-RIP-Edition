...
void SelfProtect2()
{
	...
	case 2: Option2: SelfDelete = !SelfDelete; if (SelfDelete) { print2("If on for too long game will locally overload", 5000); DamagePro = 11; }; if (!SelfDelete)DamagePro = 12; Protections(); break;
	case 3: Option3: TestFuckYou(); break;
	case 4: Option4: Pro5 = !Pro5; if (Pro5)DamagePro = 9; if (!Pro5)DamagePro = 10; Protections(); break;
	}
}
void SelfOptionP1()
{
...
void PedChanger()
{
	...
	DrawBoolOption("Play As Animals", animalplay);//be sure to use my template animal files. You will AUTO be in modders pool, just use modders pool bypass
	...
	case 4: Option4: animalplay = !animalplay; if (animalplay) { *(int*)0x00C6D944 = 0x4E800020; }if (!animalplay) { *(int*)0x00C6D944 = 0xF821FF71; }; break;

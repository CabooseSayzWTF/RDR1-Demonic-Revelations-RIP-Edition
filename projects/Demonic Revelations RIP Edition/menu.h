void MainMenu()
{
	add_title("DEMONiC Revelations V2.7 [RIP]");
...
void SelfOptionP3()
{
	...
	case 2: Option2: NoWanted = !NoWanted; if (!NoWanted) { if (NET_IS_IN_SESSION()) { SET_ACTOR_FACTION(self, 2); } }; break;
...
void PedChanger()
{
	...
	case 4: Option4: animalplay = !animalplay;if(animalplay)*(int*)0x82410D18 = 0x60000000; if (!animalplay)*(int*)0x82410D18 = 0x897F0000; break;
...
void Player_OpsSlot0P1()
{
	...
	case 7: Option7: CopyPlayer(NetSlotId); break;

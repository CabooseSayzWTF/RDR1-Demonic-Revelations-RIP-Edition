void MainMenu()
{
	// Personal note to the script kiddies, stop renaming the menu and removing the credits.
	// You didn't "crack" the menu. The menu is open source, hence why you even see this lovely message.
	// You aren't special I promise.
	// Now with that said, feel free to use the menu, and its mod functions however you like.
	// Just keep the original credits in your varation of the menu. 
	// That is all I ask of you.
	// I've grown to hate rdr and its community as a whole. Too many toxic players for my taste.
...
void SelfProtect()
{
	...
	DrawBoolOption("Ped/Vehicle", Pro6);
	...
	case 5: Option5: Pro6 = !Pro6; if (Pro6)DamagePro = 11; if (!Pro6)DamagePro = 12; Protections(); break;
...
void SelfProtect2()
{
	...
	DrawBoolOption("Self Delete", SelfDelete);
	DrawBoolOption("Spoof Camera", camspoof);
	DrawBoolOption("Block Votes", Pro5);
	switch (getOption())
	{
	case 1: Option1: UpdateSelf = !UpdateSelf; if (!UpdateSelf)SET_ACTOR_STOP_UPDATE(self, 0); break;
	case 2: Option2: AntiLite = !AntiLite; if (!AntiLite) { DESTROY_ITERATOR(iteratoranti1); DESTROY_ITERATOR(iteratoranti2); DESTROY_ITERATOR(iteratoranti3); }; break;
	case 3: Option3: SelfDelete = !SelfDelete; if (SelfDelete) { print2("If on for too long game will locally overload", 5000); DamagePro = 13; }; if (!SelfDelete)DamagePro = 14; Protections(); break;
	case 4: Option4: TestFuckYou(); break;
	case 5: Option5: Pro5 = !Pro5; if (Pro5)DamagePro = 9; if (!Pro5)DamagePro = 10; Protections(); break;
	}
}
void SelfOptionP1()
{
...
void SelfOptionP3()
{
	...
	case 4: Option4: if (NET_IS_IN_SESSION()) { if (FRun == 0) { *(long*)0x830093B8 = 1089470464; print2("<orange>Fast Walk:</orange> <green>1</green>", 3000); FRun = 1; } else if (FRun == 1) { *(long*)0x830093B8 = 1097859072; print2("<orange>Fast Walk:</orange> <green>2</green>  \n Best To Aim a Gun At This Speed For Easier Control", 6000); FRun = 2; } else if (FRun == 2) { *(long*)0x830093B8 = 1106837504; print2("<orange>Fast Walk:</orange> <green>3</green> \n Best To Aim a Gun At This Speed For Easier Control", 6000); FRun = 3; } else if (FRun == 3) { *(long*)0x830093B8 = 1065520988; print2("<orange>Fast Walk:</orange> <green>RESET</green>", 3000); FRun = 0; } }; if (!NET_IS_IN_SESSION())print2("Only Works In MP", 2000); break;
	case 5: Option5: if (!RETAILXBOX) { if (JHeight == 0) { *(short*)0x82000D60 = 16672; print2("<orange>Jump Height:</orange> <green>1</green>", 3000); JHeight = 1; } else if (JHeight == 1) { *(short*)0x82000D60 = 16968; print2("<orange>Jump Height:</orange> <green>2</green>", 3000); JHeight = 2; } else if (JHeight == 2) { *(short*)0x82000D60 = 17136; print2("<orange>Jump Height:</orange> <green>3</green>", 3000); JHeight = 3; } else if (JHeight == 3) { *(short*)0x82000D60 = 17392; print2("<orange>Jump Height:</orange> <green>4</green>", 3000); JHeight = 4; } else if (JHeight == 4) { *(short*)0x82000D60 = 16512; print2("<orange>Jump Height:</orange> <green>RESET</green>", 3000); JHeight = 0; } }; break;
	case 6: Option6: if (!RETAILXBOX) { if (FovEdit == 0) { *(long*)0x82000A88 = 1010827264; print2("<orange>Fov Adjust:</orange> <green>1</green>", 3000); FovEdit = 1; } else if (FovEdit == 1) { *(long*)0x82000A88 = 1015021568; print2("<orange>Fov Adjust:</orange> <green>2</green>", 3000); FovEdit = 2; } else if (FovEdit == 2) { *(long*)0x82000A88 = 1018167296; print2("<orange>Fov Adjust:</orange> <green>3</green>", 3000); FovEdit = 3; } else if (FovEdit == 3) { *(long*)0x82000A88 = 1007614517; print2("<orange>Fov:</orange> <green>RESET</green>", 3000); FovEdit = 0; } }; break;
	case 7: Option7: if (!RETAILXBOX) { if (visdrug == 0) { *(short*)0x82001C2C = 43520; print2("<orange>Vision:</orange> <green>Spirit World</green>", 3000); visdrug = 1; } else if (visdrug == 1) { *(short*)0x82001C2C = 17024; print2("<orange>Vision:</orange> <green>Pixelized LSD</green>", 3000); visdrug = 2; } else if (visdrug == 2) { *(short*)0x82001C2C = 65280; print2("<orange>Vision:</orange> <green>LSD Abyss</green>", 3000); visdrug = 3; } else if (visdrug == 3) { *(short*)0x82001C2C = 16256; print2("<orange>Vision:</orange> <green>RESET</green>", 3000); visdrug = 0; } }; break;
	case 8: Option8: if (!RETAILXBOX) { if (AREdit == 0) { *(long*)0x82000D68 = 1062207488; print2("<orange>Aspect Ratio Adjust:</orange> <green>1</green>", 3000); AREdit = 1; } else if (AREdit == 1) { *(long*)0x82000D68 = 1078984704; print2("<orange>Aspect Ratio Adjust:</orange> <green>2</green>", 3000); AREdit = 2; } else if (AREdit == 2) { *(long*)0x82000D68 = 1087373312; print2("<orange>Aspect Ratio Adjust:</orange> <green>3</green>", 3000); AREdit = 3; } else if (AREdit == 3) { *(long*)0x82000D68 = 1071877689; print2("<orange>Aspect Ratio:</orange> <green>RESET</green>", 3000); AREdit = 0; } }; break;
	}
}
void ProfileEditor()
{
...
void SP_1()
{
	...
	add_option("Set High Legend/Honor");
	add_option("Give <MONEY>1000");
	add_option("Give All Consumables");
	add_option("Give Undead Provisions");
	...
	case 4: Option4: GIVE_UNDEADPRO(); break;
	case 5: Option5: for (int i = 0; i <= 55; i++) { UNK_0x7D6A8D4A(i, 1); }; break;
	}
}
...
void Sub_Menu5()
{
	...
	case 3: Option3: mPass = !mPass; if (mPass) *(byte*)0x830940EC = 0; if (!mPass)*(byte*)0x830940EC = 1; break;//rockstar patch and fix your fucking game.
...
void Sub_Menu6()
{
	...
	DrawBoolOption("DeSpoof Names", SpoofDe);
...
void PedChanger()
{
	...
	DrawBoolOption("Play As Animals", animalplay);//allows playing as horses and special zombie types and other animals if mod pool files are active
	...
	case 4: Option4: if (!RETAILXBOX) { animalplay = !animalplay; if (animalplay) { *(int*)0x82410D18 = 0x60000000; print2("Press <lt> to reset anims if animal model gets stuck idle", 5000); }; if (!animalplay)*(int*)0x82410D18 = 0x897F0000; } break;
	case 5: Option5: SetStatArrayValue(161, GET_ACTOR_ENUM(self)); break;
	case 6: Option6: lodmod = !lodmod; if (DefautSavedModel > 1294 || DefautSavedModel == -1)print2("<red>Something Went Wrong or You Never Saved a Model", 3000); if (DefautSavedModel >= 0 && DefautSavedModel <= 1294) { ChangeModel(self, DefautSavedModel); modelgotloaded = 1; } if (!lodmod)modelgotloaded = 0; break;
	}
}
void PlayerList()
{
